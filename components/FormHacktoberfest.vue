<template>
  <div class="flex justify-center">
    ...
    >
      ...
      <div class="flex flex-col">
        <label class="normal-case" for="images"
          >Image (First image will be set as Main)</label
        >
      ...
      <div class="!mt-12 px-6 py-4 bg-dark-600 rounded-lg">
        <p>
          ...
          to the team that developed it. We expect that each team will have an
          agreement between themselves regarding the IP, but this is not
          required
        </p>
        ...
        <p class="mt-8">
          By making a submission you grant Supabase permission to use
          screenshots, code-snippets and/or links to your project or content of
          your README on our twitter, blog, website, email updates, and in the
          Supabase discord server. Supabase does not make any claims over your
          IP.
        </p>
        <div class="mt-2 flex items-center space-x-4">
          <input
